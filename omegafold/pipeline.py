...
def fasta2inputs(
    ...
    for i, (ch, fas) in enumerate(combined):
        ...
        out_pdb_name = os.path.join(output_dir, out_fname + ".pdb")
        out_embedding_name = os.path.join(output_dir, out_fname)
        ...
        yield utils.recursive_to(data, device=device), out_pdb_name, out_embedding_name
